...
import com.taxonic.carml.model.impl.CarmlNamespace;
...
public class XPathResolverTest {
	...
	private static final String SOURCE_NS = 
			"<?xml version=\"1.0\" encoding=\"UTF-8\"?>\r\n" + 
			"\r\n" + 
			"<bookstore xmlns:ex=\"http://www.example.com/books/1.0/\">\r\n" + 
			"\r\n" + 
...
//	private static final LogicalSource LSOURCE_NS = 
//			new CarmlLogicalSource(
//					SOURCE_NS, 
//					"/bookstore/*", 
//					Ql.XPath, 
//					ImmutableSet.of(new CarmlNamespace("ex", "http://www.example.com/books/1.0/"))
//			);
